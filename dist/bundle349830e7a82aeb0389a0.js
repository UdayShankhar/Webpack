...
function generateQuote() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('https://jsonplaceholder.typicode.com/users', config).then(function (res) {
    var result = res.data.map(function (e) {
      return e.name;
    });
    console.log(result);
...
var motivateBtn = document.getElementById('motivate');
motivateBtn.addEventListener('click', _generateQuote__WEBPACK_IMPORTED_MODULE_0__["default"]);
(0,_generateQuote__WEBPACK_IMPORTED_MODULE_0__["default"])();
})();

/******/ })()
;
//# sourceMappingURL=bundle349830e7a82aeb0389a0.js.map